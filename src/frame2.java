...
@SuppressWarnings("unchecked")
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
           try{
                ...
                cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/bank","root","1234");
                st=cn.createStatement();
		String ano,name,type,amount,p;
		...
		String query="insert into account values("+a+",'"+name+"','"+type+"',"+am+",'"+p+"')";
                int re=st.executeUpdate(query);
                if (re >= 0) {
                   String s ="Successfully saved !!";
                    JOptionPane.showMessageDialog(null, s);
                }
                else
                {
                    String s ="Account already exists";
                    JOptionPane.showMessageDialog(null, s);
                }
            } catch (Exception ex) {
                 String s ="Account already exists";
